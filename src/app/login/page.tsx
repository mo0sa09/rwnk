...
export default function LoginPage() {
  ...
  const inpStyle: React.CSSProperties = {
    ...
    outline:'none', fontFamily:"'Th','Noto Kufi Arabic','Segoe UI',Tahoma,'Geeza Pro',Arial,serif", transition:'all .2s', direction:'ltr',
  }
      ...
      <div className="auth-brand-panel" style={{ background: C.text1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:48, position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ position:'relative', zIndex:1, textAlign:'center' }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:12, marginBottom:44 }}>
            <Image src="/logo-icon.png" alt="رَوْنَق" width={34} height={40} style={{ width:34, height:40, objectFit:'contain', flexShrink:0 }} />
        ...
        <div style={{ width:'100%', maxWidth:340, position:'relative', zIndex:1 }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:18 }}>
              ...
              <button type="button" onClick={handleForgotPassword} style={{ fontSize:12, fontWeight:700, color:C.primary, background:'none', border:'none', cursor:'pointer', fontFamily:"'Th','Noto Kufi Arabic','Segoe UI',Tahoma,'Geeza Pro',Arial,serif" }}>نسيت كلمة المرور؟</button>
            </div>

            <button type="submit" disabled={loading} style={{ width:'100%', height:48, background:loading?'#8b6dd4':C.primary, color:'#fff', border:'none', borderRadius:11, fontSize:14, fontWeight:900, cursor:loading?'wait':'pointer', fontFamily:"'Th','Noto Kufi Arabic','Segoe UI',Tahoma,'Geeza Pro',Arial,serif", boxShadow:'0 2px 12px rgba(103,71,178,.28)', transition:'all .2s' }}>
          ...
          <button onClick={signInWithGoogle} style={{ width:'100%', height:44, background:'#fff', border:`1px solid ${C.border}`, borderRadius:11, fontSize:13, fontWeight:700, color:C.text2, display:'flex', alignItems:'center', justifyContent:'center', gap:9, cursor:'pointer', fontFamily:"'Th','Noto Kufi Arabic','Segoe UI',Tahoma,'Geeza Pro',Arial,serif" }}>
