...
export default function LoginPage() {
  ...
  const inpStyle: React.CSSProperties = {
    ...
    outline:'none', fontFamily:"var(--font-tajawal),'Segoe UI',Tahoma,'Geeza Pro',Arial,sans-serif", transition:'all .2s', direction:'ltr',
  }
        ...
        <div style={{ width:'100%', maxWidth:340, position:'relative', zIndex:1 }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:18 }}>
              ...
              <button type="button" onClick={handleForgotPassword} style={{ fontSize:12, fontWeight:700, color:C.primary, background:'none', border:'none', cursor:'pointer', fontFamily:"var(--font-tajawal),'Segoe UI',Tahoma,'Geeza Pro',Arial,sans-serif" }}>نسيت كلمة المرور؟</button>
            </div>

            <button type="submit" disabled={loading} style={{ width:'100%', height:48, background:loading?'#8b6dd4':C.primary, color:'#fff', border:'none', borderRadius:11, fontSize:14, fontWeight:900, cursor:loading?'wait':'pointer', fontFamily:"var(--font-tajawal),'Segoe UI',Tahoma,'Geeza Pro',Arial,sans-serif", boxShadow:'0 2px 12px rgba(103,71,178,.28)', transition:'all .2s' }}>
          ...
          <button onClick={signInWithGoogle} style={{ width:'100%', height:44, background:'#fff', border:`1px solid ${C.border}`, borderRadius:11, fontSize:13, fontWeight:700, color:C.text2, display:'flex', alignItems:'center', justifyContent:'center', gap:9, cursor:'pointer', fontFamily:"var(--font-tajawal),'Segoe UI',Tahoma,'Geeza Pro',Arial,sans-serif" }}>
